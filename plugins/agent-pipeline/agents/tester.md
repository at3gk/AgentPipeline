...
3. Write tests covering: the happy path, the edge cases the spec named, and at least one failure case. Match the repo's existing test framework.
4. Run the tests.
   - If any fail, write the failures to `.pipeline/test-results.md` and **STOP**. Do not fix the code yourself.
